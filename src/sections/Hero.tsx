        ...
        <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-10 lg:gap-16 items-center">
          <div>
            ...
            >
              ...
              match data, mathematical tools, transparent performance logic, and the $SHARK token
              utility layer.
            </motion.p>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-5">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-shark-muted leading-7 max-w-md">
                      $SHARK powers PrediShark utility, rewards, buybacks, partner access, and
                      community growth.
                    </p>
                  </div>

                  <span className="inline-flex w-fit items-center justify-center gap-2 px-3.5 py-2 rounded-full bg-shark-green/10 border border-shark-green/20 text-shark-green text-[11px] font-semibold uppercase tracking-[0.16em] whitespace-nowrap">
                    <Sparkles className="w-3.5 h-3.5" />
                    Launched
                  </span>
                </div>

                <div className="relative mb-5 overflow-hidden rounded-3xl border border-white/10 bg-black/30 min-h-[170px] sm:min-h-[210px]">
                  <img
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-shark-black/88 via-shark-black/20 to-transparent" />

                  <div className="absolute left-4 right-4 bottom-4">
                    <div className="glass rounded-2xl p-4 border border-white/10">
                      <div className="flex items-start gap-3">
                        <div className="w-9 h-9 rounded-xl bg-shark-green/10 border border-shark-green/20 flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="mt-1 text-xs sm:text-sm text-shark-white font-medium break-all">
                            {SHARK_CONTRACT_ADDRESS}
                          </p>

                          <button
                            onClick={copyContractAddress}
                            className="mt-3 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-shark-green to-shark-cyan text-shark-black text-xs font-black hover:opacity-90 transition-opacity"
                          >
                    ...
                    return (
                      ...
                      >
                        <div className="flex md:flex-col items-start gap-3">
                          <div
                            className={`w-10 h-10 rounded-2xl border flex items-center justify-center flex-shrink-0 ${styles.icon}`}
                          >
